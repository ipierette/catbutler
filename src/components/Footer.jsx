  ...
  return (
      <footer className="fixed bottom-0 left-0 right-0 w-full glass-effect shadow-lg py-1 px-3 sm:px-4 z-50 flex items-center justify-between" style={{height: '3.5rem'}}>
        ...
        <div className="flex items-center gap-2">
          ...
          <span className="text-sm sm:text-base bg-blue-900 text-white px-2 py-1 rounded-full animate-pulse">v2.2.1</span>
        </div>

        {/* Frase centralizada */}
        <div className="flex-1 flex justify-center">
          <div className="text-sm sm:text-base text-gray-800 dark:text-gray-300 text-center">
